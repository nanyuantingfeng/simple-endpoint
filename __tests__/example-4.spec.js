...
describe('simple call function connect at main page by id', () => {
  let page

  beforeAll(async () => {
    page = await global.__BROWSER__.newPage()
    await page.goto(`file://${__dirname}/../examples/example-4-multi-endpoint-instances/main.html`)
  })
  ...
  it('should call function invocations between "main" and "iframe" at other endpoint instance', async () => {
    ...
    const iframeHandle = await page.$('#iframe-0')
    const iframe = await iframeHandle.contentFrame()
    await iframe.waitForSelector('#button-1')
    const button2 = await iframe.$('#button-1')
    await button2.click()
    await page.waitFor(1000)
